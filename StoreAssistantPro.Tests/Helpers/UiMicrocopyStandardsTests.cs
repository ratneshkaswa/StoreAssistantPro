...
public sealed class UiMicrocopyStandardsTests
{
    ...
    public static TheoryData<string, string> LegacyMicrocopyCases =>
        ...
        {
            {
                Path.Combine("Modules", "Firm", "Views", "FirmWindow.xaml"),
            ...
            {
                Path.Combine("Modules", "Settings", "Views", "SystemSettingsWindow.xaml"),
            ...
            {
                Path.Combine("Modules", "Authentication", "Views", "LoginWindow.xaml"),
            ...
            {
                Path.Combine("Modules", "Authentication", "Views", "SetupWindow.xaml"),
                "Your setup is saved. You can review advanced preferences after sign-in."
            },
            {
                Path.Combine("Modules", "Inward", "Views", "InwardEntryWindow.xaml"),
            ...
            {
                Path.Combine("Modules", "Products", "Views", "ProductManagementWindow.xaml"),
